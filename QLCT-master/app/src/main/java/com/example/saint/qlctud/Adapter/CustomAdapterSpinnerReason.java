...
import java.util.ArrayList;
    ...
    public class CustomAdapterSpinnerReason extends BaseAdapter {
        Context context;
        int Layout;
        ...
        public CustomAdapterSpinnerReason(Context context, int layout, ArrayList<CustomSpinner> lua_Chon) {
...
//        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            TextView textView = view.findViewById(R.id.dropdowntextspiner);
