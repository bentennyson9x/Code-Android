...
public class Custom_adapter_spinner_style_account extends BaseAdapter {
    Context context;
    int Layout;
    ...
    public Custom_adapter_spinner_style_account(Context context, int layout, ArrayList<Custom_spinner> lua_Chon) {
