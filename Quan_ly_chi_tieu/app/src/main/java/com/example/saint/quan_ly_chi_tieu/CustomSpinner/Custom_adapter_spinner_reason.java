...
import java.util.ArrayList;
    ...
    public class Custom_adapter_spinner_reason extends BaseAdapter {
        Context context;
        int Layout;
        ...
        public Custom_adapter_spinner_reason(Context context, int layout, ArrayList<Custom_spinner> lua_Chon) {
